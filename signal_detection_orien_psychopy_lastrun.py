...
expName = 'signal_detection_orien_psychopy'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Pooja\\OneDrive\\Desktop\\Signal_Detection_experiment\\signal_detection_orien_psychopy_lastrun.py',
