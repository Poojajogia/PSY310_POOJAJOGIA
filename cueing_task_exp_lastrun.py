...
expName = 'cueing_task_exp'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Pooja\\OneDrive\\Desktop\\Solo_project_2\\cueing_task_exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    welcome_text = visual.TextStim(win=win, name='welcome_text',
        text="Welcome to the experiment!\nKeep your eyes focused on fixation cross '+' for the entire experiment.\nA target will appear on either the left or the right.\n\nIf the target appears on the LEFT, press the 'left' key. \nIf the target appears on the RIGHT, press the 'right' key.\n\nPlease respond as quickly and as accurately as you can.\nPress the SPACE bar to begin.",
        font='Arial',
    ...
    welcome = data.Routine(
        name='welcome',
        components=[welcome_text, start_key],
    )
    ...
    for thisTrial in trials:
        ...
        trial = data.Routine(
            name='trial',
            components=[fixation, cue_text, target, key_resp],
        )
        trial.status = NOT_STARTED
        continueRoutine = True
        # update component parameters for each repeat
        cue_text.setText(cue_arrow)
        ...
        while continueRoutine:
            ...
            if cue_text.status == STARTED:
                ...
                if tThisFlip > 0.8-frameTolerance:
                    ...
                    cue_text.tStopRefresh = tThisFlipGlobal  # on global time
            ...
            if target.status == NOT_STARTED and tThisFlip >= 1.1-frameTolerance:
                # keep track of start time/frame for later
            ...
            if key_resp.status == NOT_STARTED and tThisFlip >= 1.1-frameTolerance:
                # keep track of start time/frame for later
