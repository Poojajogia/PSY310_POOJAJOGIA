...
expName = 'intentional_binding_exp'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Pooja\\OneDrive\\Desktop\\Intentional_binding_experiment\\intentional_binding_exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    text = visual.TextStim(win=win, name='text',
        text='Report the delay between the key press and beep sound (0-900); Click submit after entering the value',
        font='Arial',
    ...
    for thisTrial in trials:
        ...
        sound_1.setVolume(3.0, log=False)
        sound_1.seek(0)
