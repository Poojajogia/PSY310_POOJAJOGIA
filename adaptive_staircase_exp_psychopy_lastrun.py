...
expName = 'adaptive_staircase_exp_psychopy'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Pooja\\OneDrive\\Desktop\\Adaptive_Staircase_exp\\adaptive_staircase_exp_psychopy_lastrun.py',
