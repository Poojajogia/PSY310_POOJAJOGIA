...
expName = 'Motor_sequence_exp'  # from the Builder filename that created this script
expVersion = ''
...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='C:\\Users\\Pooja\\OneDrive\\Desktop\\Motor_Sequence_experiment\\Motor_sequence_exp_lastrun.py',
...
def run(expInfo, thisExp, win, globalClock=None, thisSession=None):
    ...
    trials = data.TrialHandler2(
        ...
        extraInfo=expInfo, 
        originPath=-1, 
        trialList=data.importConditions('sequence_conditions.csv'), 
        seed=None, 
    )
    ...
    for thisTrial_2 in trials_2:
        ...
        routine_2 = data.Routine(
            name='routine_2',
            components=[fixation_2, line_1, line_2, line_3, line_4, probe_2, key_resp_2],
        )
        ...
        while continueRoutine:
            ...
            if key_resp_2.status == STARTED and not waitOnFlip:
                theseKeys = key_resp_2.getKeys(keyList=['z','x','c','v'], ignoreKeys=["escape"], waitRelease=False)
